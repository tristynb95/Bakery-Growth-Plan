...
exports.handler = async function(event, context) {
  ...
  try {
    ...
    // --- UPDATED PROMPT TO ENSURE ALL 3 TABLES ARE GENERATED ---
    const prompt = `
      ...
      **Primary Goal:** Your main task is to generate three complete tables, one for each month of the 90-day plan.
      ...
      6.  Populate the table body (<tbody>) with the action items for that specific month.
      ...
      8.  For ALL table data cells (<td>) in the first five columns, add the attribute contenteditable="true".
