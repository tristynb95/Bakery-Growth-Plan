    ...
    function renderSummary() {
        ...
        DOMElements.contentArea.innerHTML = `<div class="space-y-8 summary-content">
                                                <div class="content-card p-6">
                                                    <h2 class="text-2xl font-bold font-poppins mb-4">Our Quarterly Narrative</h2>
                                                    ...
                                                    <div class="mb-6"><h4 class="font-semibold text-sm text-gray-500">My Vision For This Quarter</h4><div class="text-gray-800 prose prose-sm">${e(formData.quarterlyTheme)}</div></div>
